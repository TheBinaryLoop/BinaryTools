...
namespace BinaryTools.Security.Credentials
{
    public abstract class BaseCredentialsPrompt : ICredentialsPrompt
    {
        ...
        protected virtual CREDUI_INFO CreateCREDUI_INFO(IntPtr owner)
        {
        ...
        public string Message
        {
            ...
            set
            {
                ...
                if (value.Length > Constants.CREDUI_MAX_MESSAGE_LENGTH)
                {
        ...
        public string Title
        {
            ...
            set
            {
                ...
                if (value.Length > Constants.CREDUI_MAX_CAPTION_LENGTH)
                {
                    throw new ArgumentOutOfRangeException("value");
                }
                _title = value;
        ...
        public string Username
        {
            ...
            set
            {
                ...
                if (value.Length > Constants.CREDUI_MAX_USERNAME_LENGTH)
                {
                    throw new ArgumentOutOfRangeException("value");
                }
                _username = value;
        ...
        public string Password
        {
            ...
            set
            {
                ...
                if (value.Length > Constants.CREDUI_MAX_PASSWORD_LENGTH)
                {
                    throw new ArgumentOutOfRangeException("value");
                }
