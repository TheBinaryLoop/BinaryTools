...
namespace BinaryTools.Security.Credentials
{
    public class Credential : IDisposable
    {
        ...
        public bool Save()
        {
            ...
            bool result = Advapi32.CredWrite(ref credential, 0);
            if (!result)
            {
                return false;
            }
        ...
        public bool Delete()
        {
            ...
            bool result = Advapi32.CredDelete(target, Type, 0);
            return result;
        }
        ...
        public bool Load()
        {
            ...
            bool result = Advapi32.CredRead(Target, Type, 0, out credPointer);
            if (!result)
            {
                return false;
            }
